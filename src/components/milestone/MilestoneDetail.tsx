...
interface Props {
    ...
    onClose: () => void;
    onEdit: (milestone: FrontendMilestone) => void;
...
export default function MilestoneDetail({
    ...
    function doDeleteSeries() {
        if (m.recurrence_id && onDeleteSeries) {
            ...
            <div className="sheet">
                ...
                <div className="detail-meta">
                    ...
                    {(() => {
                        ...
                        return age !== null ? <div className="detail-age">{age} y.o.</div> : null;
                    })()}
                </div>
                    ...
                    <div className="sheet-actions">
                        <div className="detail-delete-group">
                            ...
                            {m.recurrence_id && onDeleteSeries && (
                                <button
                                    type="button"
                                    className="btn-ghost detail-delete-series"
