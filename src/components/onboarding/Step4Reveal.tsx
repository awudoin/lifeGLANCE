...
export default function Step4Reveal({
    ...
    const futureMonths = useCountUp(futureInfo?.months ?? 0, {
        active: phase === "row2" || phase === "cta",
        duration: 900,
        delay: 800,
    });
    const futureDays = useCountUp(futureInfo?.days ?? 0, {
        active: phase === "row2" || phase === "cta",
        duration: 1100,
    });
    ...
    const formatFutureTime = () => {
        ...
        if (futureInfo.years > 0) {
            ...
            return futureInfo.months > 0 ? `in ${yr}, ${futureMonths} mo` : `in ${yr}`;
        }
    ...
    const formatPastTime = () => {
        ...
        if (pastInfo.years > 0) {
            ...
            return pastInfo.months > 0 ? `${yr}, ${pastMonths} mo ago` : `${yr} ago`;
        }
