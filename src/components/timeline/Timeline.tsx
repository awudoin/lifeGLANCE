...
const Timeline = forwardRef<TimelineHandle, TimelineProps>(function Timeline(
    ...
    const TITLE_LH = Math.round(remPx * 0.9);
    ...
    //   cards maximize space above and axis sits just above the minimap bar.
    //   Floor at 193 prevents card overflow at very small heights.
    // normal: axis centred.
    const axisY = compactLayout ? Math.max(193, h - 40) : Math.round(h * 0.5);
            ...
            >
                ...
                {ticks.map((tick) => (
                    <g key={`${tick.label}-${tick.x}`}>
                        <line
                            x1={tick.x}
                            y1={axisY - (tick.major ? 7 : 3)}
                            x2={tick.x}
                            y2={axisY + (tick.major ? 7 : 3)}
                    ...
                    (() => {
                        ...
                        return (
                            <g
                                style={{
                                    filter: centered
                                        ? "drop-shadow(0 0 6px #C8A96E) drop-shadow(0 0 14px #C8A96E55)"
                                        : "none",
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        ...
                                                        <rect
                                                            ...
                                                            height={4}
                                                            rx={0.4}
                                                            fill={isPlaying ? m.color : "none"}
                                                            stroke={m.color}
                                                            strokeWidth={0.85}
                                                        />
                                                        {/* Cone */}
                                                        <path
                                                            d="M4,2 L7.5,0.5 L7.5,10.5 L4,9 Z"
                                                            fill={isPlaying ? m.color : "none"}
                                                            stroke={m.color}
                                                            strokeWidth={0.85}
                                            ...
                                            if (type === "video")
                                                return (
                                                    ...
                                                    >
                                                        ...
                                                        <path
                                                            d="M8.5,4 L13,2.5 L13,8.5 L8.5,7 Z"
                                                            fill="none"
                                                            stroke={m.color}
                                                            strokeWidth={0.85}
                                                            strokeLinejoin="round"
                                            ...
                                            if (type === "recurrence")
                                                return (
                                                    ...
                                                    >
                                                        ...
                                                        <path
                                                            d="M 10.0,7.5 A 4,4 0 0,1 3.0,7.5"
                                                            fill="none"
                                                            stroke={m.color}
                                                            strokeWidth={0.9}
                                                            strokeLinecap="round"
                                                        ...
                                                        <polyline
                                                            points="9.5,3.5 10.5,5.5 11.5,3.5"
                                                            fill="none"
                                                            stroke={m.color}
                                                            strokeWidth={0.9}
                                                            strokeLinecap="round"
                                                        ...
                                                        <polyline
                                                            points="1.5,7.5 2.5,5.5 3.5,7.5"
                                                            fill="none"
                                                            stroke={m.color}
                                                            strokeWidth={0.9}
                                                            strokeLinecap="round"
