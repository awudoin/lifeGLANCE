...
export function useTypewriter(
    text: string,
    { delay = 26, jitter = 24, startDelay = 0, active = true }: TypewriterOptions = {},
) {
    ...
    }, [text, active, delay, jitter, startDelay]); // eslint-disable-line react-hooks/exhaustive-deps
...
export function useCountUp(
    target: number,
    { duration = 1200, active = false, delay = 0 }: CountUpOptions = {},
): number {
