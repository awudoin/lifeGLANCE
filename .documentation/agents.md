...
- When making changes to the database schema, always keep database.md up-to-date
- When making changes to the API surface, always keep api.md up-to-date
- Typescript with full type annotations should be used when making any changes
